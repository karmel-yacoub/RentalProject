      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display:flex;justify-content:space-evenly;">
       		<a href="/admin/apps" style="text-align: center;width:250px !important;height:250px !important;"type="button" class="btn btn-danger">Appartments:<c:out value="${y }"></c:out></a>
